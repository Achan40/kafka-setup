...
inputs = {
  ...
  kafka_advertised_listeners           = "INTERNAL://kafka2.${dependency.ecs.outputs.ecs_private_dns_ns_name}:9092,EXTERNAL://kafka1.${dependency.ecs.outputs.ecs_private_dns_ns_name}:29092"
