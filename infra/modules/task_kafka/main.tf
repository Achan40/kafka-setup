...
# resource "aws_service_discovery_service" "broker2" {
#   name = "broker2"
#   dns_config {
#     namespace_id = aws_service_discovery_private_dns_namespace.kafka_ns.id
#     dns_records { 
...
#         { name = "KAFKA_PROCESS_ROLES", value = "broker,controller" },
#         { name = "KAFKA_CONTROLLER_QUORUM_VOTERS", value = "1@broker1.kafka.local:9093, 2@broker2.kafka.local:9093"},
#         { name = "KAFKA_LISTENERS", value = "INTERNAL://0.0.0.0:9092,CONTROLLER://0.0.0.0:9093,EXTERNAL://0.0.0.0:29092"},
#         { name = "KAFKA_ADVERTISED_LISTENERS", value = "INTERNAL://broker2.kafka.local:9092,EXTERNAL://broker2.kafka.local:29092" },
#         { name = "KAFKA_LISTENER_SECURITY_PROTOCOL_MAP", value = "INTERNAL:PLAINTEXT,CONTROLLER:PLAINTEXT,EXTERNAL:PLAINTEXT" },
#         { name = "KAFKA_INTER_BROKER_LISTENER_NAME", value = "INTERNAL" },
#         { name = "KAFKA_CONTROLLER_LISTENER_NAMES", value = "CONTROLLER" },
#         { name = "KAFKA_AUTO_CREATE_TOPICS_ENABLE", value = "true" },
#         { name = "KAFKA_GROUP_ID", value = "my-group" }
#       ]
...
#   service_registries {
#     registry_arn = aws_service_discovery_service.broker2.arn
#   }
# }